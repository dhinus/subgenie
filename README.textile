...
* You will be presented with a list of unmerged commits, you can now choose to merge all of them or just some.
* All will be duly recorded in the standard svn mergeinfo property

h2. Requirements

This has been tested with subversione 1.6 and 1.7. This should theoretically work with 1.5 as well.
